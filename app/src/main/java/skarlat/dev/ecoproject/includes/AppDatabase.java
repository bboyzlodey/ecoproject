 ...
 */
@Database(entities = {СoursesDB.class, CardsDB.class}, version = 4)
public abstract class AppDatabase extends RoomDatabase {
    public abstract CoursesDao cursCardDao();
    public abstract CardsDao cardsDao();
//    public static final Migration MIGRATION = new Migration(3, 4) {
//        @Override
//        public void migrate(final SupportSQLiteDatabase database) {
//            database.execSQL("CREATE TABLE СoursesDB (id INTEGER NOT NULL, cursID TEXT NOT NULL, checkList TEXT, progressBar INTEGER NOT NULL, PRIMARY KEY(cursID))");
